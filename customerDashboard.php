                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                    ...
                                    $querypaid="SELECT OrderID as 'startmanu' FROM orders WHERE OrderStatus='Approved' AND ManufacturingStatus IS 'Pending'";
                                  ...
                                  if ($paid == 0){
                                      ...
                                      echo "<li><a href='approveClientAccounts.php'>You order was approved</a></li>";
                                  }
                                  else if ($paid > 1){
                                      echo "<li><a href='approveClientAccounts.php'>Your orders have been approved</a></li>";
                                  }
