            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-18">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Account Requests</h4>
...
<td><a href=\"accountRequest01.php?id=$id \">{$row['CName']}</td>
<td>{$row['CRepName']}</td>
<td>{$row['CRepContactNo']}</td>
<td>{$row['CRepEmailAdd']}</td>
<td>
<div align=\"center\">
<form action=\"accountRequests.php\" method=\"post\">
<input type = \"submit\" name =\"accept\" class=\"btn btn-success btn-fill\" value=\"ACCEPT\">
<input type = \"hidden\" name =\"id\" class=\"\" value=\"".$id."\">
</form>
<td>
<form action=\"accountRequests.php\" method=\"post\">
<input type = \"submit\" name =\"reject\" class=\"btn btn-danger btn-fill\" value=\"REJECT\">
<input type = \"hidden\" name =\"id\" class=\"\" value=\"".$id."\">
</form>
</div></td>
</tr>";
