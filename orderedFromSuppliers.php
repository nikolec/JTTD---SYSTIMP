            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Order vinyl or hair from suppliers.
                            </p>
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            if ((!empty($_POST['dsc'] && $_POST['qty']))) {  
                                ...
                                if ($qty > 1){
                                echo "<center>Order of ".$qty." kilograms of $dsc $supplytype sent to $supplier!</center>";
                                }
                                else{
                                echo "<center>Order of ".$qty." kilogram of $dsc $supplytype sent to $supplier!</center>";
                                }
                            ...
                            <br>
                            <br>
                            <center><a href="orderFromSuppliers.php"><input type="submit" value="Back"></a></center>
