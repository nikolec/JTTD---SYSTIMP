                    ...
                    <div class="header">
                     ...
                     <div class="content">
                        <div class="row">
                            ...
                            <form action="addedSuppliers.php" method="post">
                            <div class="col-md-5">
                                ...
                                $query="SELECT DISTINCT(SupplyType) From Suppliers";
                                
                                echo "Supply type:   <select name='type'>";
                                
                                $result=mysqli_query($dbc,$query);
                                
                                
                                while ($row = mysqli_fetch_array($result)){
                                echo "<option value={$row['SupplyType']}>{$row['SupplyType']}</option>";

                                }
                                echo "</select> <br>";
                                ?>
                                
                                Supplier country: <input type='text' name='country'><br>
