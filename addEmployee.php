...
$message=NULL;
 ...
 if (empty($_POST['EmpUsername'])){
  $EmpUsername=FALSE;
  $message.='<p>You forgot to enter the employee username!';
 }else{
...
if (empty($_POST['EmpContactNo'])){
  $EmpContactNo=FALSE;
  $message.='<p>You forgot to enter the employee conatct number!';
 }
 else if(!preg_match('/^[0-9]*$/',$_POST['EmpContactNo'])){
  $message.='<p>Invalid employee contact number!'; 
 }
 else{
...
if (empty($_POST['EmpEmailAdd'])){
  $EmpEmailAdd=FALSE;
  $message.='<p>You forgot to enter the employee email address!';
 }else{
...
if (empty($_POST['EmpPassword'])){
  $EmpPassword=FALSE;
  $message.='<p>You forgot to enter the employee password!';
 }
 if(empty($_POST['pass2'])){
   ...
   $EmpPassword=$_POST['EmpPassword'];
    //$CRepPassword=$_POST['pass'];
  $Confirmpassword=$_POST['pass2']; // not sure if correct, should be a "confirm password"
  if($EmpPassword == $Confirmpassword) {
  $EmpName=$_POST['EmpName'];
  $query="INSERT INTO `appdev`.`employeeaccount` (`EmployeeID`, `EmployeeName`, `EmployeeContactNo`, `EmployeeEmailAdd`, `EmployeeUsername`, `EmployeePassword`) VALUES (NULL, '$EmpName', '$EmpContactNo', '$EmpEmailAdd', '$EmpUsername', PASSWORD('$EmpPassword'));";
  
  
  mysqli_query($dbc,$query);
  
  echo "The account of ".$EmpName." has been activated";
  }
else {
...
$message="<b><p>Employee Name: {$EmpName}<br>
                Company Address: {$EmpContactNo}<br>
                Company Contact Number: {$EmpEmailAdd}<br>
                Company Email Address: {$EmpUsername}<br>
                Company Representative Name: {$EmpPassword}<br>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-18">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add employees</h4>
                                <p class="category">Add employees by creating accounts for them.</p>
                            </div>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;Employee Name:&nbsp;&nbsp;&nbsp;
    <input type="text" name="EmpName" size="20" maxlength="30" value="<?php if (isset($_POST['EmpName']) && !$flag) echo $_POST['EmpName']; ?>"/>

<p>&nbsp;&nbsp;&nbsp;&nbsp;Contact Number:&nbsp;&nbsp;&nbsp; 
    <input type="text" name="EmpContactNo" size="20" maxlength="12" value="<?php if (isset($_POST['EmpContactNo']) && !$flag) echo $_POST['EmpContactNo']; ?>"/>

<p>&nbsp;&nbsp;&nbsp;&nbsp;E-mail Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="email" name="EmpEmailAdd" size="20" maxlength="30" value="<?php if (isset($_POST['EmpEmailAdd']) && !$flag) echo $_POST['EmpEmailAdd']; ?>"/>

<p>&nbsp;&nbsp;&nbsp;&nbsp;Username:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="text" name="EmpUsername" size="20" maxlength="30" value="<?php if (isset($_POST['EmpUsername']) && !$flag) echo $_POST['EmpUsername']; ?>"/>

<p>&nbsp;&nbsp;&nbsp;&nbsp;Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="password" name="EmpPassword" size="20" maxlength="30" value="<?php if (isset($_POST['EmpPassword']) && !$flag) echo $_POST['EmpPassword']; ?>"/>

  <p>&nbsp;&nbsp;&nbsp;&nbsp;Confirm Password: 
    <input type="password" name="pass2" size="20" maxlength="30" value="<?php if (isset($_POST['pass2']) && !$flag) echo $_POST['pass2']; ?>"/>


<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" class="btn btn-success btn-fill" value="ADD" /></div>
