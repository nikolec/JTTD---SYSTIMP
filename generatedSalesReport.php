 ...
 <!----------------------- END NOTIFICATIONS --------------------------------------------------------------->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Generated Sales Report</h4>
                        <p class="category">Generated Sales report for entries between dates 
                            <?php 
                        ...
                        <div class="row">
                            ...
                            if ((!empty($_POST['startDate'] && $_POST['endDate'])) && ($_POST['startDate'] < $_POST['endDate'])) {  
                                ...
                                $_SESSION['end']=$eD;
                                    ...
                                    <td width="10%"><div align="center"><b><font color="white">Date Ordered</font>
                                    </div></b></td>
                                    <td width="10%"><div align="center"><b><font color="white">Date Shipped</font>
                                    </div></b></td>
                                    <td width="10%"><div align="center"><b><font color="white">Date Paid</font>
                                    </div></b></td>
                                    </tr>';


                                    $query="SELECT OrderID, OQuantity, OTotalAmount, OOrderedDate, OShippedDate, OPaymentDate From Orders where OPaymentDate between '$sD' AND '$eD'";
                                    ...
                                    if ($row['OShippedDate'] == NULL){
                                        echo "<td width=\"10%\"><div align=\"center\">Not Shipped</div></td>";
                                    }
                                    else if ($row['OShippedDate'] != NULL){
                                    ...
                                    $query1="SELECT SUM(OQuantity) AS qnt, SUM(OTotalAmount) AS amt From Orders where OPaymentDate between '$sD' AND '$eD'";
                                    ...
                                    <td width=\"10%\"><div align=\"right\"><b>{$row['qnt']}</b>
                                    </div></td>

                                    <td width=\"10%\"><div align=\"right\"><b>{$row['amt']}</b>
                                    </div></td>
                            ...
                            <br>
                            <br>
                            <center><a href="generateSalesReport.php"><input type="submit" value="Back"></a></center>
