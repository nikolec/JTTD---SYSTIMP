...
if (isset($_POST['submit'])){
        ...
        echo $specificationName; 
          ...
          $message="{$specificationName} added!<br>";
            ...
            header("location:createNewSpecNext.php");
...
<head>
  ...
  <title>Create New Doll Specification</title>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                <div class="header">
                  <h4 class="title">Create New Doll Specification</h4>
                    ...
                    <div class="row">
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <input type="text" name="specificationName" class="form-control" placeholder="Specification Name" required>
                        </div>
                      </div>
                    </div>
