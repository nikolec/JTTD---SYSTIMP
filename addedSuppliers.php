            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        ...
                        <p class="category">Add suppliers.</p>
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            if (empty($_POST['supplier']) || empty($_POST['country'])) {
                                echo "<center><font color='red'>Incomplete input.
                                <br>Please click Back to try again.</center>";
                            }
                                
                            
                            if ((!empty($_POST['supplier'] && $_POST['type'] && $_POST['country']))) {  
                                require_once('../mysql_connect.php');
                                $supplier = $_POST['supplier'];    
                                $type = $_POST['type'];
                                $country = $_POST['country'];

                                $query="insert into `suppliers` (SupplierID, SupplierName, SupplierCountry, SupplyType) values (NULL,'{$supplier}', '{$country}','{$type}')";
                                
                                $result=mysqli_query($dbc,$query);
                                
                                echo "<center>Supplier: $supplier<br>
                                            Country: $country <br>
                                            Type: $type<br>
                                            added!</center>";
                            ...
                            <br>
                            <br>
                            <center><a href="addSuppliers.php"><input type="submit" value="Back"></a></center>
