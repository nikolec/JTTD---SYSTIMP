...
<head>
    ...
    <title>Activate account: <?php echo $id; ?></title>
 ...
 <!----------------------- END NOTIFICATIONS --------------------------------------------------------------->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Activate account: <?php echo $id; ?> </h4>
...
<form action = "accountRequest01.php?id=<?php echo $id; ?>" method = "POST">
    <button type="submit" name = "accept" class="btn btn-success btn-fill pull-left">ACTIVATE</button>
