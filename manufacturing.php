...
if (isset($_POST['start'])){
    $id=$_POST['id'];
    $sql = "UPDATE Orders 
            SET StartManufacturing = DATE(NOW()), ManufacturingStatus = 'In Progress' 
...
if (isset($_POST['end'])){
    $id=$_POST['id'];
    $sql = "UPDATE Orders 
            SET EndManufacturing = DATE(NOW()), ManufacturingStatus = 'Completed' 
            WHERE OrderID = " . $_POST['id'];
}
                    ...
                    <div class="col-md-18">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Start and end manufacturing for doll orders.</p>
                            </div>
...
$query="SELECT * 
        from Orders O, ClientAccount C 
        WHERE OPaymentStatus = 'Paid' AND CompanyID = OCompanyID AND ManufacturingStatus != 'Completed'";
...
<td><a href=dollOrder02.php?id=<?php echo $id; ?>><?php echo $row[0]; ?></a></td>
...
<td><form action="manufacturing.php" method="post">

<?php
if($row['ManufacturingStatus'] == 'In Progress'){
  ?>

  <button type = "submit" name ="end" class="btn btn-danger btn-fill" value="$id">END</button>
  <input type = "hidden" name ="id"  value="<?php echo $id; ?>">
  <?php  
}
 else{
    ?>
<button type = "submit" name ="start" class="btn btn-success btn-fill" value="$id">START</button>
<input type = "hidden" name ="id"  value="<?php echo $id; ?>">
