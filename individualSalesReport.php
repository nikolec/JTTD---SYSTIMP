...
<head>
	...
	<title>Individual Sales Report</title>
 ...
 <!----------------------- END NOTIFICATIONS --------------------------------------------------------------->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Individual Sales Report for Order #<?php echo $_GET['id']; ?> </h4>
                        <p class="category">Individual Sales report of <b> Order #<?php echo $_GET['id']; ?> </b> between dates 
                            <?php 
                            echo $_SESSION["start"]." and ".$_SESSION["end"].".";
                    ...
                    <div class="content">
                        <div class="row">
                            ...
                            if (isset($_GET["id"])){
                                ...
                                if ($mstatus = 'Pending'){
                                    echo "<td width=\"10%\"><div align=\"center\">Manufacturing has not yet started</div></td><tr>";
                                    echo "<tr>
                                    <td width=\"10%\"><div align=\"center\"><b>End Date</b>
                                    </div></td>
                                    <td width=\"10%\"><div align=\"center\">Manufacturing has not yet started</div></td></tr>";
                                }
                            ...
                            <br>
                            <center>
                                <form action="generatedSalesReport.php" method="post">
                                    <input type="hidden" name="startDate" value="<?php echo $startDate; ?>">
                                    <input type="hidden" name="endDate" value="<?php echo $endDate; ?>">
                                    <br>
                                    <input type="submit" method="Back" name="Back" value="Back"></form></center>
