...
if(isset($_GET['id'])){
    $orderID = $_GET['id'];
    $query = "SELECT *,
              ClientAccount.CName AS 'Name',
              Product.ProductType AS 'Type',
              Product.ProductName AS 'PName' 
              FROM Orders O 
              INNER JOIN ClientAccount ON O.OCompanyID=ClientAccount.CompanyID 
              INNER JOIN Product ON O.OProductID=Product.ProductID WHERE OrderID ='".$orderID."' ";
    $result = mysqli_query($dbc,$query);
    while($row=mysqli_fetch_array($result)){
$productID = $row['OProductID'];
        $reqDate = $row['ORequiredDate'];
...
$requiredDate = $_POST['rdate'];
$orderID = $_GET['id'];
    $total2 = $newPrice*$quantty;
    ...
    //echo "{$orderID}<br>";
        ...
        $query444="UPDATE `orders` SET `OQuantity` = '".$quantty."', `OPrice` = '".$newPrice."', `OTotalAmount` = '".$total2."', `ORequiredDate` = '".$requiredDate."' WHERE `orders`.`OrderID` = ".$orderID.";";
        
        /*$query444="UPDATE Orders 
                  SET ORequiredDate= $requiredDate,
                      OPrice= $newPrice,
                      OQuantity=$quantty,
                      OTotalAmount=$total2
        ...
        mysqli_query($dbc,$query444);
    header("location:dollOrder01.php?id=$orderID");
    //echo "open";
                    ...
                    <div class="header">
                        ...
                        <br>
                            ...
                            if (isset($_GET['id'])){
                                ...
                                <form action="dollOrder01EDIT.php?id='.$id.'" method="post">
                                ...
                                <td width=\"10%\"><div align=\"right\">$id
                                </div></td>
                                </tr>
                                ...
                                <?php
                                if ($pstatus != 'Paid') {
                                    echo "<input type = 'date' style = 'text-align:right;' name='rdate' value ='$rdate'>";
                                }
                                ...
                                if ($row['OrderStatus'] == "Accepted" && $row['OPaymentStatus'] == "Unpaid"){
                                    echo 'Not yet paid';
                                }
                                else{
                                    echo $pstatus;
                                ...
                                <td width=\"10%\"><div align=\"center\">
                                <input type = 'number' style = 'text-align:right;' min='1' name = 'price' value = '$price'>
                                </div></td>
                                </tr>
                                ...
                                <td width=\"10%\"><div align=\"center\">
                                <input type = 'number' style = 'text-align:right;' min='1' name ='qty' value = '$qty'>
                                </div></td>
                                </tr>
                                ...
                                <td width=\"10%\"><div align=\"left\">$prodname
                                </div></td>
                                </tr>
...
<?php
                            ...
                            <input type = \"submit\" id = \"submit\" name =\"submit\" class=\"\" value=\"UPDATE\">
