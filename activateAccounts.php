 ...
 <!----------------------- END NOTIFICATIONS --------------------------------------------------------------->
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="card">
                    <div class="header">
                        <h4 class="title">Activate Accounts</h4>
                        <p class="category">View and activate all approved client accounts by assigning usernames and passwords.</p>
...
if (isset($_POST['activate'])){
	...
	echo
	"
	&nbsp;&nbsp;&nbsp;&nbsp;<font color='green'>The account of <b>$CName</b> has been activated</font>
	";
	...
	echo
	"
	&nbsp;&nbsp;&nbsp;&nbsp;<font color='red'><b>ERROR! Passwords do not match</b></font>
	";
}
...
$numRows = mysqli_num_rows($result);
	...
	<form action="activateAccounts.php" method="post">
	<td align ="left"><input type="text" name="user" size="20" maxlength="30" value=""/></td>
	<td align ="left"><input type="password" name="pass" size="20" maxlength="30" value=""/></td>
	<td align ="left"><input type="password" name="pass2" size="20" maxlength="30" value=""/></td>
	<input type = "hidden" name = "CName" value= "'.$CName.'">
	<input type = "hidden" name = "CompanyID" value= "'.$id.'">
	
	<td align = "left"><input type="submit" name="activate" class="btn btn-success btn-fill" value="ACTIVATE" /></td>
	</form>'
	;
	echo '</tr>';
}
